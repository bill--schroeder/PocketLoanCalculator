...
public class baseActivityAmazon extends baseActivity implements AdListener
{
    ...
    private static final String APP_KEY = "4a63d3e0c5a54bc9be6e743b06c4c7d7"; // Sample Application Key. Replace this variable with your Application Key
    private static final String LOG_TAG = "PocketLoanCalculator"; // Tag used to prefix all log messages
